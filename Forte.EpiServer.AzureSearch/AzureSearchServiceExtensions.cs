...
namespace Forte.EpiServer.AzureSearch
{
    ...
    {
        public static async Task<IReadOnlyCollection<SearchResult<T>>> SearchBatchAsync<T>(
            this IAzureSearchService searchService,
            AzureSearchQuery query,
        ...
        public static IReadOnlyCollection<SearchResult<T>> SearchBatch<T>(
            this IAzureSearchService searchService,
            AzureSearchQuery query,
            string indexName = null,
            int batchSize = 1000)
